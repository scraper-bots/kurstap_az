      ...
      <div className="mt-16 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-600">Get detailed analysis of your interview performance with actionable insights.</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-600">Practice with questions from top companies and various industries.</p>
          </div>
          <div className="text-center">
